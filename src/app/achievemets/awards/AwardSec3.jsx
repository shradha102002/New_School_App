...
export default function AwardSec3() {
  return (
    <div style={{ position: 'relative', minHeight: '100vh', overflowY: 'auto' }}>
      ...
      <div
        style={{
          ...
          height: '50vh',
          marginTop: '250px',
          backgroundImage: 'url("/about_chairman/chairman2.jpg")',
      ...
      >
        <Card title="DANCE CLASSES" value={158} suffix="+"/>
        <Card title="BEST INSTRUCTOR" value={49} suffix="+" />
        <Card title="TOTAL BRANCH" value={17} suffix="+"/>
        <Card title="HAPPY CUSTOMERS" value={567} suffix="+"/>
      </div>
    </div>
  );
}
