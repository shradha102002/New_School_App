...
export default function ActivitiesSection4() {
  return (
    <div style={{ position: 'relative', minHeight: '100vh', overflowY: 'auto' }}>
      ...
      >
        <Card title="HAPPY STUDENTS" value={10000} suffix="+"/>
        <Card title="CBSE RESULT" value={100} suffix="%" />
        <Card title="QUALIFIED STAFF" value={1000} suffix="+"/>
        <Card title="STUDENT AWARDS WON" value={2000} suffix="+"/>
      </div>
    </div>
  );
}
